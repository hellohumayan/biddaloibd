          ...
          <div className="flex items-center justify-between h-11 sm:h-12">
            ...
            <nav className="hidden lg:flex items-center space-x-1 xl:space-x-2">
              ...
              >
                ...
                {/* Dropdown Menu */}
                {isCountriesOpen && (
                  <div className="absolute top-full left-0 mt-1.5 w-72 sm:w-80 bg-white rounded-2xl shadow-xl border border-slate-200/90 p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                    <div className="grid grid-cols-2 gap-1">
                      {destinationsData.map((country) => (
                        <button
                          ...
                          className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-left hover:bg-blue-50/80 group transition-colors cursor-pointer"
                        >
                          <img
                            src={country.flagImage}
                            alt={`${country.name} flag`}
                            className="w-6 h-4 object-cover rounded-xs border border-slate-200/90 shadow-2xs shrink-0"
                            loading="eager"
            ...
            <div>
              ...
              <div className="p-4 space-y-1">
                ...
                <div>
                  ...
                  {mobileCountriesOpen && (
                    <div className="p-1.5 space-y-0.5 bg-slate-50/80 rounded-xl mt-1 mb-2 border border-slate-100">
                      {destinationsData.map((country) => (
                        <button
                          key={country.id}
                          onClick={() => handleCountryClick(country.id)}
                        ...
                        >
                          <img
                            src={country.flagImage}
                            alt={`${country.name} flag`}
                            className="w-5 h-3.5 object-cover rounded-xs border border-slate-200/90 shadow-2xs shrink-0"
                            loading="eager"
                            referrerPolicy="no-referrer"
                          />
